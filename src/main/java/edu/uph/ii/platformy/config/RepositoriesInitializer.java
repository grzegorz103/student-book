    ...
    InitializingBean init ()
    {
        return () -> {
            ...
            if ( this.specializationRepository.findAll ()
                    .isEmpty () )
            {
                this.specializationRepository.save ( new Specialization ( 1L, "Bazy danych", 30L, courseRepository.findById ( 1L )
                        .orElse ( null ) ) );
                this.specializationRepository.save ( new Specialization ( 2L, "Programowanie", 20L, courseRepository.findById ( 1L )
                        .orElse ( null ) ) );
                this.specializationRepository.save ( new Specialization ( 3L, "Optyka", 20L, courseRepository.findById ( 4L )
                        .orElse ( null ) ) );
                this.specializationRepository.save ( new Specialization ( 4L, "Nanostruktury", 20L, courseRepository.findById ( 3L )
                        .orElse ( null ) ) );
            }
