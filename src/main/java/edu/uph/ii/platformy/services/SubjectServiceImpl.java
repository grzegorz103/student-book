...
public class SubjectServiceImpl implements SubjectService
{
    ...
    @Autowired
    public SubjectServiceImpl ( SubjectRepository subjectRepository, LessonRepository lessonRepository, AttendanceRepository attendanceRepository, StudentRepository studentRepository, AccountRepository accountRepository )
    {
    ...
    {
        Attendance attendance = attendanceRepository.findById ( atd )
                .get ();
